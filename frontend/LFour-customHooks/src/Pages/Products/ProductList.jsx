...
export const ProductList = () => {
  useTitle("All eBooks - Shop Programming Books");
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                <input 
                  ...
                  className="w-4 h-4"
                />
                <label htmlFor="inStock" className="ml-2 dark:text-gray-300">In Stock Only</label>
              </div>
              ...
              <div className="flex items-center">
                <input 
                  ...
                  className="w-4 h-4"
                />
                <label htmlFor="bestseller" className="ml-2 dark:text-gray-300">Best Sellers Only</label>
              </div>
