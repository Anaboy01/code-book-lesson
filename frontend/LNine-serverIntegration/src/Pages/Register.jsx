                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 sm:p-10 border border-gray-100 dark:border-gray-700">
                    <div className="mb-8 text-center">
                        ...
                        <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
                            ...
                            <Link to="/login" className="font-semibold text-rose-600 dark:text-rose-500 hover:underline">
                                Log in instead
                            </Link>
                        </p>
                    </div>
                    ...
                    <div className="mt-8 bg-gray-50 dark:bg-gray-700/60 border border-gray-100 dark:border-gray-600 rounded-xl p-4">
                        <p className="text-sm text-gray-600 dark:text-gray-300">
                            By creating an account you agree to our <span className="font-medium text-rose-600 dark:text-rose-500">Terms of Service</span> and{" "}
                            <span className="font-medium text-rose-600 dark:text-rose-500">Privacy Policy</span>. We respect your inbox—no spam, ever.
                        </p>
                    </div>
                </div>
            </section>
