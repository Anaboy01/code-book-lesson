            ...
            <button className="cursor-pointer dark:text-gray-50 relative top-10 left-10">
                ...
                <div className="flex flex-wrap justify-around">
                    ...
                    <div className="max-w-xl my-3">
                        ...
                        <p className="my-3">
                            {!inCart && 
                                <button onClick={() => addToCart(product)} className={`inline-flex items-center py-2 cursor-pointer px-5 text-lg font-medium text-center text-white bg-rose-600 rounded-lg hover:bg-rose-700 ${product.in_stock ? "" : "cursor-not-allowed"}`}
