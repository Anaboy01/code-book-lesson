        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 sm:p-10 border border-gray-100 dark:border-gray-700">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
              ...
              <span onClick={handleLoginGuest} className="text-rose-600 dark:text-rose-500 cursor-pointer font-medium">
                continue as guest
              </span>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div>
              ...
              <input
                ...
                type="email"
                id="email"
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-rose-500 focus:border-rose-500 block w-full p-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-rose-500 dark:focus:border-rose-500"
            ...
            <button
              type="submit"
              className="w-full text-white cursor-pointer bg-rose-600 hover:bg-rose-700 focus:ring-4 focus:outline-none focus:ring-rose-500 font-medium rounded-lg text-sm px-5 py-3 text-center dark:bg-rose-600 dark:hover:bg-rose-700 dark:focus:ring-rose-800 transition-colors"
            >
              Log In
            </button>
          </form>
          ...
          <div className="mt-8 text-center text-sm text-gray-600 dark:text-gray-300">
            Need an account?{" "}
            <Link to="/register" className="font-semibold text-rose-600 dark:text-rose-500 hover:underline">
              Create one now
            </Link>
          </div>
          ...
          <button
            ...
            type="button"
            className="mt-6 w-full cursor-pointer text-white bg-rose-600 hover:bg-rose-700 focus:ring-4 focus:outline-none focus:ring-rose-500 font-medium rounded-lg text-sm px-5 py-3 text-center dark:bg-rose-600 dark:hover:bg-rose-700 dark:focus:ring-rose-800 transition-colors"
          >
            Login As Guest
          </button>
        </div>
