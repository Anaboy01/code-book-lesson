  ...
  return (
    <section className="flex flex-col lg:flex-row dark:text-slate-100 items-center px-[50px] gap-6">
        <div className="text my-5">
            ...
            <Link to="/products" type="button" className="text-white bg-rose-600 hover:bg-rose-700 focus:ring-4 focus:ring-rose-500 font-medium rounded-lg text-base px-5 py-2.5 mr-2 mb-2 dark:bg-rose-600 dark:hover:bg-rose-700 focus:outline-none dark:focus:ring-rose-800">Explore eBooks</Link>
        </div>
