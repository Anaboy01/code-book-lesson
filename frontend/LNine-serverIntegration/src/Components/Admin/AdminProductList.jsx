   ...
   <div className="p-6">
            ...
            <div className="mb-4">
                <input
                    ...
                    className="w-full max-w-md px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-rose-500"
                />
            </div>
                                    ...
                                    <tr key={product.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <button
                                                ...
                                                className="text-blue-600 hover:text-blue-700 transition mr-3"
                                            >
                                                Edit
                                            </button>
                                            <button
